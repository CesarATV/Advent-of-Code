...
/// 
/// The functions to solve the first and the second part of the puzzle could be easily fused together as they share the same structure. They are left separated for clarity and because the program is fast enough.
/// 

const PUZZLE_INPUT_FILE_NAME: &str = "puzzleInputs/day10.txt";
const PUZZLE_EXAMPLE_INPUT_FILE_NAME: &str = "puzzleInputs/day10_example.txt";
