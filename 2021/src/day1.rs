const PUZZLE_INPUT_FILE_NAME: &str = "puzzleInputs/day1.txt";
const PUZZLE_EXAMPLE_INPUT_FILE_NAME: &str = "puzzleInputs/day1_example.txt";

const SLIDING_WINDOW_SIZE: usize = 3;

fn first_part(mut lines: core::str::Lines)
{
