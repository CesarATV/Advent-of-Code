...
#define PUZZLE_INPUT_FILE_NAME "puzzleInputs/day13.txt"
#define PUZZLE_EXAMPLE_INPUT_FILE_NAME "puzzleInputs/day13_example.txt"
...
{
    const std::string your_name ("you"); // arbitrary chosen. It should be different from any name already in family_names_vector
